...
from Tests.networks.net_architectures import architectures
import os
...
def run_alpha():
    ...
    for j in range(0, 10):
        ...
        for i in range(0, 10):      
            params_pso["alpha"] += 10
            experiment1 = Experiment(params_pso, architectures["1in_cubic"], path="1in_cubic.txt", debugMode=False, sampleMode=True)
            experiment1.run()
    ...
    for j in range(0, 10):
        ...
        for i in range(0, 10):      
            params_pso["alpha"] += 10
            experiment1 = Experiment(params_pso, architectures["1in_linear"], path="1in_linear.txt", debugMode=False, sampleMode=True)
            experiment1.run()
    ...
    for j in range(0, 10):
        ...
        for i in range(0, 10):      
            params_pso["alpha"] += 10
            experiment1 = Experiment(params_pso, architectures["1in_sine"], path="1in_sine.txt", debugMode=False, sampleMode=True)
            experiment1.run()
    ...
    for j in range(0, 10):
        ...
        for i in range(0, 10):      
            params_pso["alpha"] += 10
            experiment1 = Experiment(params_pso, architectures["1in_tanh"], path="1in_tanh.txt", debugMode=False, sampleMode=True)
            experiment1.run()
    ...
    for j in range(0, 10):
        ...
        for i in range(0, 10):      
            params_pso["alpha"] += 10
            experiment1 = Experiment(params_pso, architectures["2in_complex"], path="2in_complex.txt", debugMode=False, sampleMode=True)
            experiment1.run()
    ...
    for j in range(0, 10):
        ...
        for i in range(0, 10):      
            ...
            experiment1 = Experiment(params_pso, architectures["2in_xor"], path="2in_xor.txt", debugMode=False, sampleMode=True)
            experiment1.run()
